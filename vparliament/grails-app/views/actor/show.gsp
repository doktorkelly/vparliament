	...
	<body>
		...
		<div id="show-actor" class="content scaffold-show" role="main">
			...
			<ol class="property-list actor">
				...
				<li class="fieldcontain">
					<span id="firstName-label" class="property-label"><g:message code="actor.firstName.label" default="First Name" /></span>
					
						<span class="property-value" aria-labelledby="firstName-label"><g:fieldValue bean="${actorInstance}" field="firstName"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${actorInstance?.votes}">
				<li class="fieldcontain">
					<span id="votes-label" class="property-label"><g:message code="actor.votes.label" default="Votes" /></span>
